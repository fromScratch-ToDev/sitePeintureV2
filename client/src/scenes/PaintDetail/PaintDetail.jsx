...
import FooterDescriptionPaint from "./components/FooterDescriptionPaint";
import ModalConfirm from "../../components/Modal";
import ButtonModal from "../../components/ButtonModal";
import {deleteImage, changeCategory} from './api_bdd.js'
...
function ZoomPaint({paintSelected, setIsPaintZoomed, categoriesNames, paintArray, setPaintArray}) {
    ...
    useEffect(() => {
        ...
        // Attacher l'événement keydown à l'objet window
        ...
        <div className={classes.div}>
            ...
            <img src={paintSelected.urlPaint} className={classes.img} alt=" vue pleine écran avec description" onClick={handleClickIMG}></img>
               ...
               <ModalConfirm id="modalDeleteImage"
                    ...
                    buttonConfirm = {
                        <ButtonModal text="oui" f={() => deleteImage(paintSelected, paintArray, setPaintArray, setIsPaintZoomed)}></ButtonModal>
                    }
                    buttonCancel = {
               ...
               <ModalConfirm id="modalChangeCategory"
                    ...
                    buttonConfirm = {
                        <ButtonModal text="confirmer" f={() => changeCategory(paintSelected, setIsPaintZoomed)}></ButtonModal>
                    }
                    buttonCancel = {
